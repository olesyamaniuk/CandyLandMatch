document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".w-i-navigation-list");
  const headerRef = document.querySelector(".w-i-header");
  const navigationRef = document.querySelector(".w-i-navigation");
